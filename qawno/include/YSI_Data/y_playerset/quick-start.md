...
new gpDataEngkq[MAX_PLAYERS][E_PLAYER_DATA];

gpDataEngkq[player0][E_PLAYER_DATA_ADMIN] = true;
gpDataEngkq[player5][E_PLAYER_DATA_ADMIN] = true;
gpDataEngkq[player88][E_PLAYER_DATA_ADMIN] = true;
SendText(gpDataEngkq<E_PLAYER_DATA_ADMIN>, "Hi same random three players.");
```
